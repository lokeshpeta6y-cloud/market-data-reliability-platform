"""
MDRP Ops API — demo runner with mock data.

Runs the full API surface locally without needing the infrastructure
stack (Kafka, Redis, S3). Useful for demoing the platform contract,
testing client integrations, and local development.
...
app = FastAPI(
    ...
    description=(
        ...
        "> _Demo mode — runs against mock data without the full infrastructure stack._"
    ),
    version="0.1.0",
    docs_url="/docs",
    redoc_url="/redoc",
